...
//geting product from database for index.php page
	...
	function viewComplain(){
		...
		while ($row_comp=mysqli_fetch_array($run_complain)) {
			
			$complain_id = $row_comp['complain_id'];
			$user_name  = $row_comp['user_name'];
			$user_email  = $row_comp['user_email'];
			$product_title  = $row_comp['product_title'];
			$product_brand = $row_comp['product_brand'];
			$product_image = $row_comp['product_image'];
			$author_address = $row_comp['author_address'];
			$author_phone_number = $row_comp['author_phone_number'];
			$product_desc = $row_comp['product_desc'];
		}
		...
		<h4>$user_name</h4>
			...
			<h4>$product_title</h4>
			<h4>$product_brand</h4>
			<img src='admin_area/complain_images/'$product_image width='200' height='200'/>
